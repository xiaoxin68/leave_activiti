        ...
        <nav class="navbar navbar-inner">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <!--nav troggle-->
                    <!--brand-->
                    <a class="navbar-brand" href="#">教务自动化请假系统</a>
                    <!--brand-->
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                <span class="glyphicon glyphicon-sunglasses" aria-hidden="true"></span> ${username}
                            </a>
                ...
                <div class="panel-group menu" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="panel panel-inner">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                            <div class="list-group list-group-self">
                                ...
                                <a href="querMyLeaveBill" target="appiframe" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span>我的请假单</a>
                    ...
                    <div class="panel panel-inner">
                        ...
                        <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                            <div class="list-group list-group-self">
                                ...
                                <!-- <a href="viewCurrentImage"  target="appiframe" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span>查看流程</a> -->
                                <a href="static/images/LeaveBill.png"  target="appiframe" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span>查看流程</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-inner">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="list-group list-group-self">
                                <a href="getEmployeeList"  target="appiframe" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span> 用户列表</a>
                            </div>
                        </div>
                    </div>
